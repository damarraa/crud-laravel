                        ...
                        <form action="{{ route('authors.update', $authors->id) }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name', $authors->name) }}" placeholder="Type Authors Name">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="bio" id="bio" rows="5" class="form-control @error('bio') is-invalid @enderror"
                                    placeholder="Type Authors Bio">{{ old('bio', $authors->bio) }}</textarea>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="birth_date" id="birth_date"
                                    ...
                                    value="{{ old('birth_date', $authors->birth_date) }}"
                                    placeholder="Authors Birth Date">
